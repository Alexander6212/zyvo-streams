...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "ZYVO IPTV — Premium Live TV & VOD Streaming" },
      { name: "twitter:description", content: "20,000+ live channels, 60,000+ VOD titles, 99.9% uptime. Stream in 4K on any device — start your free ZYVO IPTV trial today." },
